...
public interface TorneoRepository extends JpaRepository<Torneo, Integer> {
    ...
    @Query("SELECT t FROM Torneo t JOIN FETCH t.deporte JOIN FETCH t.olimpiada WHERE t.olimpiada.id = :olimpiadaId AND t.deporte.id = :deporteId ORDER BY t.nombre ASC")
    ...
    @Query("SELECT t FROM Torneo t JOIN FETCH t.deporte JOIN FETCH t.olimpiada WHERE t.deporte.id = :deporteId ORDER BY t.nombre ASC")
    List<Torneo> findByDeporteIdOrderByNombreAsc(@Param("deporteId") Integer deporteId);

    @Query("SELECT t FROM Torneo t JOIN FETCH t.deporte JOIN FETCH t.olimpiada ORDER BY t.nombre ASC")
