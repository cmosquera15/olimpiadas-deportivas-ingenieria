...
public class UsuarioCreateDTO {
    ...
    @NotBlank
    private String rolNombre; // ADMINISTRADOR | ARBITRO | JUGADOR

    private String documento; // opcional
    private Integer id_programa_academico; // opcional
    private Integer id_genero; // opcional
    private Integer id_eps; // opcional
    private Integer id_tipo_vinculo; // opcional
