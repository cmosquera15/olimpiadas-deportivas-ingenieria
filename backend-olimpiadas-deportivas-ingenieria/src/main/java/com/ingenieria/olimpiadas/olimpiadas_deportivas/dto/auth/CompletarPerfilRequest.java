...
public class CompletarPerfilRequest {
    ...
    @Pattern(regexp = "^[0-9]{6,12}$", message = "Documento inválido (solo dígitos, 6-12)")
    private String documento;

    @NotNull(message = "id_eps es obligatorio")
    private Integer id_eps;

    @NotNull(message = "id_programa_academico es obligatorio")
    private Integer id_programa_academico;

    @NotNull(message = "id_genero es obligatorio")
    private Integer id_genero;

    @NotNull(message = "id_tipo_vinculo es obligatorio")
